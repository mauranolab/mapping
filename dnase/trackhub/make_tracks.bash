...
project=CEGS  # project=CEGS for both values of hub_type. It's used by samplesforTrackhub.R to allow
              # the R code to be used for other purposes.
...
if [ ${hub_type} = "CEGS" ]; then
    urlbase_in="https://cegs:bigdna@cascade.isg.med.nyu.edu/cegs/mapped/"
else
    urlbase_in="https://mauranolab:chromatin@cascade.isg.med.nyu.edu/~cadlej01/mapped/"
fi
...
if [ ${hub_type} = "CEGS" ]; then
    urlbase_in="https://cegs:bigdna@cascade.isg.med.nyu.edu/cegs/aggregations/"
else
    urlbase_in="https://mauranolab:chromatin@cascade.isg.med.nyu.edu/~cadlej01/aggregations/"
fi
...
if [ ${hub_type} = "CEGS" ]; then
    urlbase_in="https://cegs:bigdna@cascade.isg.med.nyu.edu/cegs/publicdata/"
else

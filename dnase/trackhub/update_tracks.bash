...
#
#                                 https://cegs:bigdna@cascade.isg.med.nyu.edu/cegs/trackhub_dev
#                                 =============================================================
#                                                     Arg 5
#
...
#                                   https://mauranolab:chromatin@cascade.isg.med.nyu.edu/~cadlej01/trackhub
#
############################################################################
...
echo "# Hub was constructed at:" $(date +"%m-%d-%y %T") >> "${hub_target}/hub.txt"

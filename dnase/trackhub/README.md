...
mlr --tsv cut -f DS,Age,Institution ../SampleIDs.tsv | ${src}/trackhub/samplesforTrackhub.R --quiet --inputfile - --project humanENCODEdnase --out ../SamplesForTrackhub.tsv

cd /vol/isg/encode/chipseq/mapped/
mlr --tsv cut -f DS,Age,Institution ../SampleIDs.tsv | ${src}/trackhub/samplesforTrackhub.R --quiet --inputfile - --project humanENCODEchipseq --out ../SamplesForTrackhub.tsv

cd /vol/isg/encode/mouseencode/mapped/
mlr --tsv cut -f DS,Age,Institution ../SampleIDs.tsv | ${src}/trackhub/samplesforTrackhub.R --quiet --inputfile - --project mouseENCODEdnase --out ../SamplesForTrackhub.tsv

cd /vol/isg/encode/mouseencode_chipseq/mapped/
mlr --tsv cut -f DS,Age,Institution ../SampleIDs.tsv | ${src}/trackhub/samplesforTrackhub.R --quiet --inputfile - --project mouseENCODEchipseq --out ../SamplesForTrackhub.tsv
```

...
echo "track name=$sample description=\"$sample cut counts (${nonredundantTagsM}M nonredundant tags- BWA alignment\" maxHeightPixels=30 color=$trackcolor viewLimits=0:3 autoScale=off visibility=full type=bigWig bigDataUrl=https://mauranolab:chromatin@cascade.isg.med.nyu.edu/~mauram01/mapped/FC/$sample.perBase.bw"

...
##Create list for Umi1 and append Umi2 to each match             #ERROR #TODO why isn't this working
#             Umi_adj_Dict = {} #Create directory
#             for umi in umis:
#             	umiCounts = counts[umi]
#             	umiCode=umi.encode()
#             	nearbyUmis = [] #add Umi as key in list
#             	[umi2 for umi2 in umis if umi != umi2 and umiCounts >= (counts[umi2]*2)-1 and edit_distance(umiCode, umi2.encode()) == 1]

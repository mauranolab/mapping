...
#              	#print(umiCounts)
#              	for umi2 in umis:
#              		umi2Counts = counts[umi2]
#              		umi2Code=umi2.encode()
#              		if umi!= umi2: 
#              			if umiCounts>= (umi2Counts*2)-1:
#              				if edit_distance(umiCode, umi2Code) == 1:
#              					print(umi, umi2)
#              	
#Create list for Umi1 and append Umi2 to each match             
             ...
             return Umi_adj_Dict
              	...
              	#	#print(umi2Counts)
              	#	#print(umi, umi2)
              	#	if counts[umi] >= (counts[umi2]*2)-1 and edit_distance(umiCode, umi2Code) == 1:
              	#		print (umi, umi2)
              	#	
              	#return umi_list
              	#print(umi_list)
              ...
              #return {umi: [umi2 for umi in umis
              #					print(umi)
              #					for umi2 in umis:

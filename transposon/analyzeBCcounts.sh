...
if [ "${minCellBCLength}" -gt 0 ]; then
    ...
    if [[ "${sample}" =~ T0190 ]]; then
        ...
        genotypeClonesArgs="--blacklist /vol/mauranolab/ribeia01/transposon_10x/T0219toT0221/blacklist_multisite.txt --annotateclones /vol/mauranolab/ribeia01/transposon_10x/T0219toT0221/bc_transfection-occurrence.txt.gz"
    else
